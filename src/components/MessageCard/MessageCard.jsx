...
const MessageCard = ({ conversation }) => {
    ...
    const otherUserName = (latestChat.senderUid === loggedinUser.uid) ? latestChat.receiver : latestChat.sender
    const otherUserPic = (latestChat.senderUid === loggedinUser.uid) ? latestChat.receiverPic : latestChat.senderPic
